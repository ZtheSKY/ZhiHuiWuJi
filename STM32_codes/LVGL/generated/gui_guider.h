...
typedef struct
{
	...
	lv_obj_t *screen_cont_para;
	lv_obj_t *screen_btn_para;
	lv_obj_t *screen_btn_para_label;
	lv_obj_t *screen_roller_para;
	lv_obj_t *screen_label_2;
	lv_obj_t *screen_label_3;
	lv_obj_t *screen_ddlist_mode;
	lv_obj_t *screen_cont_but;
	lv_obj_t *screen_btn_small;
	lv_obj_t *screen_btn_small_label;
	lv_obj_t *screen_btn_large;
	lv_obj_t *screen_btn_large_label;
	lv_obj_t *screen_label_4;
	lv_obj_t *screen_label_5;
	lv_obj_t *screen_label_6;
	lv_obj_t *screen_label_7;
	lv_obj_t *screen_cont_slider;
	lv_obj_t *screen_slider_4;
	lv_obj_t *screen_label_9;
	lv_obj_t *screen_label_8;
	lv_obj_t *screen_slider_3;
	lv_obj_t *screen_btn_slider;
	lv_obj_t *screen_btn_slider_label;
	lv_obj_t *screen_ddlist_1;
	lv_obj_t *screen_label_10;
	lv_obj_t *screen_cont_part;
	lv_obj_t *screen_slider_startx;
	lv_obj_t *screen_label_11;
	lv_obj_t *screen_slider_starty;
	lv_obj_t *screen_slider_endx;
	lv_obj_t *screen_slider_endy;
	lv_obj_t *screen_label_12;
	lv_obj_t *screen_label_13;
	lv_obj_t *screen_label_14;
	lv_obj_t *screen_label_startx;
	lv_obj_t *screen_label_starty;
	lv_obj_t *screen_label_endx;
	lv_obj_t *screen_label_endy;
	lv_obj_t *screen_btn_part_start;
	lv_obj_t *screen_btn_part_start_label;
	lv_obj_t *screen_btn_return;
	lv_obj_t *screen_btn_return_label;
}lv_ui;
...
LV_IMG_DECLARE(_logo_alpha_344x96);
